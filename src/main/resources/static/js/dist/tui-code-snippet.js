...
/***/ (function(module, exports, __webpack_require__) {
	...
	/**
	 * Close the popup
	 * @param {boolean} [skipBeforeUnload] - If true, the 'window.onunload' will be null and skip unload calendar.
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/**
	 * A unit of calendar handler item.
	 * @ignore
	 * @typedef {object} HandlerItem
	 * @property {function} fn - calendar handler
	 * @property {object} ctx - context of calendar handler
	 */
	...
	function CustomEvents() {
	    ...
	    /**
	     * only for checking specific context calendar was binded
	     * @type {object[]}
	     */
	    this.contexts = null;
	}
	...
	/**
	 * Get calendar object safely
	 * @param {string} [eventName] - create sub calendar map if not exist.
	 * @returns {(object|array)} calendar object. if you supplied `eventName`
	 ...
	 * @param {object} ctx - context that used for bind custom calendar
	...
	/**
	 * Bind calendar handler
	 * @param {(string|{name:string, handler:function})} eventName - custom
	 *  calendar name or an object {eventName: handler}
	...
	/**
	 * Bind one-shot calendar handlers
	 * @param {(string|{name:string,handler:function})} eventName - custom
	 *  calendar name or an object {eventName: handler}
	 * @param {function|object} [handler] - handler function or context
	 * @param {object} [context] - context for binding
	...
	/**
	 * Unbind calendar by calendar name
	 * @param {string} eventName - custom calendar name to unbind
	 * @param {function} [handler] - handler function
	 * @private
	 */
	...
	/**
	 * Unbind calendar by handler function
	 * @param {function} handler - handler function
	 * @private
	 */
	...
	/**
	 * Unbind calendar by object(name: handler pair object or context object)
	 ...
	 * @param {(string|object|function)} eventName - calendar name or context or
	 ...
	 *
	 * //-- #2. Use property --//
	 * // # 2.1 off by calendar name
	 * CustomEvents.off('onload');
	 *
	 * // # 2.2 off by calendar name and handler
	 ...
	 *
	 * // # 2.6 off by context and calendar name
	...
	/**
	 * Fire custom calendar
	 * @param {string} eventName - name of custom calendar
	 */
	...
	/**
	 * Fire a calendar and returns the result of operation 'boolean AND' with all
	 *  listener's results.
	 *
	 * So, It is different from {@link CustomEvents#fire}.
	 *
	 * In service code, use this as a before calendar in component level usually
	 *  for notifying that the calendar is cancelable.
	 * @param {string} eventName - Custom calendar name
	 ...
	 * map.on({
	 *     'beforeZoom': function() {
	 *         // It should cancel the 'zoom' calendar by some conditions.
	 ...
	 *  calendar name.
	 * @param {string} eventName - Custom calendar name
	 * @returns {boolean} Is there at least one handler in calendar name?
	 */
	 ...
	 * @param {string} eventName - Custom calendar name
	 * @returns {number} number of calendar
	 */
